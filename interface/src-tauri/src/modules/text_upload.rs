use crate::config::TextUploadConfig;
use crate::setup;
use chrono;
...
pub async fn upload_file(
    ...
    if !config.supported_formats.iter().any(|format| format.to_lowercase() == extension) {
        return Err(format!(
    ...
    println!("File uploaded: {} -> {}", original_filename, dest_path.display());
