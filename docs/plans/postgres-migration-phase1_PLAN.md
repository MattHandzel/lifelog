...
- [ ] **Task 1.3: Schema Redesign (The Core Architecture)**
...
- [ ] **Task 1.4: Server State Initialization**
...
- [ ] **Task 2.1: Refactor `SurrealIngestBackend`**
...
- [ ] **Task 3.2: Temporal `DuringQuery` Translation (Massive Performance Win)**
...
- [ ] **Task 4.2: Legacy Data Migration (Optional/Strategic)**
